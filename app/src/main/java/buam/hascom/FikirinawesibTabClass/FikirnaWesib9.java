 ...
 */
public class FikirnaWesib9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fikirinawesib9);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager23);
        setupViewPager(viewPager);

        tabLayout = (TabLayout) findViewById(R.id.tabs23);
