 ...
 */
public class FikirnaWesib10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fikirinawesib10);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager24);
        setupViewPager(viewPager);

        tabLayout = (TabLayout) findViewById(R.id.tabs24);
