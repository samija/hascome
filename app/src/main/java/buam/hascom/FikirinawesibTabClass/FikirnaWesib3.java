 ...
 */
public class FikirnaWesib3 extends AppCompatActivity {
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fikirinawesib3);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager17);
        setupViewPager(viewPager);

        tabLayout = (TabLayout) findViewById(R.id.tabs17);
