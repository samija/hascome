 ...
 */
public class FikirnaWesib1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fikirinawesib1);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager15);
        setupViewPager(viewPager);

        tabLayout = (TabLayout) findViewById(R.id.tabs15);
