 ...
 */
public class FikirnaWesib5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fikirinawesib5);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager19);
        setupViewPager(viewPager);

        tabLayout = (TabLayout) findViewById(R.id.tabs19);
