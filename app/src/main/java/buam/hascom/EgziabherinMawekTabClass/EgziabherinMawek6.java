 ...
 */
public class EgziabherinMawek6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egziabherin_mawek6);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager32);
