 ...
 */
public class EgziabherinMawek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egziabherin_mawek);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager26);
        setupViewPager(viewPager);

        tabLayout = (TabLayout) findViewById(R.id.tabs26);
