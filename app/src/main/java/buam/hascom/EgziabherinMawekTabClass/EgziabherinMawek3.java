 ...
 */
public class EgziabherinMawek3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egziabherin_mawek3);
        ...
        viewPager = (ViewPager) findViewById(R.id.viewpager29);
        setupViewPager(viewPager);

        tabLayout = (TabLayout) findViewById(R.id.tabs29);
